...
class OrderApplicationTests {
    ...
    public void testCreatePaymentIntent() {
        ...
        final PaymentIntent response = stripeService.createPaymentIntent(PaymentIntentRequest.builder()
                .amount(amount)
        ...
        // Do nothing scenario
        final PaymentIntent doNothing = stripeService.createPaymentIntent(PaymentIntentRequest.builder()
                .amount(amount)
                .orderReference("64eb982fe021a97a4a922f6abcd")
                .customerEmail("nava.arul@gmail.com")
                .currency("GBP")
        ...
        final PaymentIntent updateIntent = stripeService.createPaymentIntent(PaymentIntentRequest.builder()
                .amount(newAmount)
                .orderReference("64eb982fe021a97a4a922f6abcd")
                .customerEmail("nava.arul@gmail.com")
                .currency("GBP")
